...
const Phase3Button = ({ onClick }) => {
  return (
    <div>
      <button
        className="px-10 py-3 bg-gradient-to-r from-blue-500 to-blue-900 rounded-full shadow-xl group-hover:shadow-2xl group-hover:shadow-blue-600 shadow-blue-600 uppercase font-serif tracking-widest relative overflow-hidden group text-transparent cursor-pointer z-10 after:absolute after:rounded-full after:bg-blue-200 after:h-[85%] after:w-[95%] after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 hover:saturate-[1.15] active:saturate-[1.4]"
        style={{
          WebkitBoxReflect:
      ...
      >
        Button
        <p className="absolute text-white z-40 font-semibold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent top-1/2 left-1/2 -translate-x-1/2 group-hover:-translate-y-full h-full w-full transition-all duration-300 -translate-y-[30%] tracking-widest">
          PHASE .._ 3
        </p>
        <p className="absolute text-white z-40 top-1/2 left-1/2 bg-gradient-to-r from-blue-700 to-green-700 bg-clip-text text-transparent -translate-x-1/2 translate-y-full h-full w-full transition-all duration-300 group-hover:-translate-y-[40%] tracking-widest font-extrabold">
          GO
        </p>
        <svg
